...
class AWSWebSocketProvider {
    ...
    _handleIncomingSubscriptionMessage(message) {
        ...
        if (type === constants_1.MESSAGE_TYPES.GQL_ERROR ||
            type === constants_1.MESSAGE_TYPES.EVENT_SUBSCRIBE_ERROR) {
            ...
            if (observer) {
                ...
                if (type === constants_1.MESSAGE_TYPES.EVENT_SUBSCRIBE_ERROR) {
                ...
                this.logger.debug(`${PubSub_1.CONTROL_MSG.CONNECTION_FAILED}: ${errorMessage}`);
                observer.error({
                    errors: [
                        {
                            ...new graphql_1.GraphQLError(`${PubSub_1.CONTROL_MSG.CONNECTION_FAILED}: ${errorMessage}`),
                        },
                    ],
                });
                if (startAckTimeoutId)
